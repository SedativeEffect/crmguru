# crmguru
<b>Приложение по получению информации по введенной стране через стороннее API</b><br/>
2 функциональности на выбор пользователя:<br/> 
Ввод названия страны; <br/>
вывод всех стран с БД; <br/>
